      ...
      <section className={`${styles.formLayout} ${styles.fullPageReview}`}>
        ...
        <main className={`${styles.mainContent} p-4`}>
          ...
          <div className='mt-8 flex justify-center space-x-4'>
            ...
            <button
              type='button'
              onClick={() => handleVerifyAndSubmit('license')}
              className='rounded-lg bg-yellow-500 px-6 py-2 font-semibold text-white shadow transition duration-200 hover:bg-yellow-600'
            >
              Download License (TXT)
            </button>
            <button
              type='button'
              onClick={() => handleVerifyAndSubmit('odrl')}
