// drt_frontend/app/components/NegotiationHeader.tsx
"use client";
...
export default function NegotiationHeader({ userType, userEmail, isLoading, pageTitle }: NegotiationHeaderProps) {
      ...
      <div className="container-default section-y w-full">
        <div className="flex items-start justify-between gap-4 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-2 sm:mt-3 md:mt-4 lg:mt-5 md:pl-6 lg:pl-10">
              <h2 className="text-white font-bold text-lg sm:text-xl md:text-2xl font-sans truncate">
